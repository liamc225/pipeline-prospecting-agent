...
import { SYSTEM_PROMPT } from "../../src/config.shared.js";
...
const PROSPECTING_SCHEMA = {
  ...
  properties: {
    ...
    market_intelligence: { type: ["string", "null"] },
  },
  required: [
    "account_id",
    "company",
...
Contact: ${contact}
CRM Platform: ${account.crm_platform}
Notes: ${account.notes}
    ...
    tools: [
      {
        ...
        description:
          "Structured prospecting output for a B2B account. You MUST call this tool with your complete analysis.",
